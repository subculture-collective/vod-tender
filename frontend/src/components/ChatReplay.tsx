...
// Helper: Get Twitch badge image URL
function getBadgeUrl(set: string, version: string) {
    // This uses the default Twitch CDN for global badges
    // For channel badges, you may need to fetch badge sets from Twitch API
